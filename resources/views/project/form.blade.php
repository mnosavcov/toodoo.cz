                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST"
                        ...
                        <div class="form-group{{ $errors->has('key') ? ' has-error' : '' }}">
                            <label for="key" class="col-md-2 control-label">Klíč</label>
                        ...
                        <div id="description-secret"
                            ...
                            <div class="col-md-10">
                                    <textarea id="description_secret" class="form-control"
                                              ...
                                              rows="15">{{ old('description_secret', ((isset($project->description_secret) && $project->description_secret)?decrypt($project->description_secret):'')) }}</textarea>
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST"
                            ...
                            <div class="form-group{{ $errors->has('user_email') ? ' has-error' : '' }}">
                                <label for="user_email" class="col-md-2 control-label">Email uživatele</label>
