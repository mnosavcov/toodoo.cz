...
class AccountController extends Controller
{
	...
	{
		$trashed_projects = Project::onlyTrashed()->select('id');
		$trashed = Task::onlyTrashed()->select('id')->unionAll($trashed_projects)->get();
		return view('account.trash', ['trashed' => $trashed]);
	}
}
