...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'affil_hash', 'mailing_enabled', 'overpayment', 'activation_token', 'active'
    ];
    ...
    {
        $user_size = $this->main_size + max($this->paid_size, $this->ordered_unpaid_size);
